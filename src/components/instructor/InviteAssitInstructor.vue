<template>
   <div class="invite-students-container">
      ...
      <div class="form">
         ...
         <button class="small-button" type="submit" @click="inviteInstructor">
            Add Instructor
         </button>
      </div>
      ...
      <div v-if="hasSubmittedStudents" class="popup-overlay">
         <div class="success">
            ...
            <button @click="hasSubmittedStudents = false" class="small-button">
               Close
            </button>
         </div>
      </div>
...
export default {
   ...
   methods: {
      ...
      submitInstructor() {
         ...
         apiClient
            .post(
               `${this.$baseURL}/api/v1/auth/register/assistantInstructor/inviteInstructors`,
