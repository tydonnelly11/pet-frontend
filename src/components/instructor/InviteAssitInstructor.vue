<template>
    <div class="invite-students-container">
        ...
        <div class="form">
            ...
            <button class="small-button" type="submit" @click="inviteInstructor">Add Instructor</button>
        </div>
        ...
        <button class="small-button" style="max-width: 250px;" type="submit" @click="submitInstructor">Invite Instructors</button>
        ...
        <div v-if="hasSubmittedStudents" class="popup-overlay">
            ...
            <button @click="hasSubmittedStudents = false" class="small-button">Close</button>
        </div>
