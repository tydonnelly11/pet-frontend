      ...
      <ul class="nav-links">
         ...
         <li class="nav-item">
            <router-link
               @click="toggleSidebar"
               class="nav-link"
               to="/instructorhome/manageassistant"
            >
               <font-awesome-icon
                  v-if="isSidebarOpen"
