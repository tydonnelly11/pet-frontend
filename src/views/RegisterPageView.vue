      ...
      <div class="registration-container">
         <div class="registration-box">
            ...
            <div class="student-info">
               <p>
                  Confirm the email is you and then enter in a password. DO NOT
                  USE your TCU password : {{ this.studentInfo.email }}
               </p>
            </div>
            ...
            <div class="loading" v-if="this.isLoading">
               <p>
                  Request being processed...DO NOT REFRESH
...
export default {
   ...
   methods: {
      getRegistrationInfo() {
         axios
            .get(
               `http://localhost:80/api/v1/auth/register/student/getStudentRegistrationTokenInfo/${this.token}`,
               {}
            )
            .then((response) => {
      ...
      registerStudent() {
         ...
         axios
            .post(
               `http://localhost:80/api/v1/auth/register/student`,
               {
