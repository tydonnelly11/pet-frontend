         ...
         <div class="row g-0">
            ...
            <div class="right col-md-6">
               <div class="input-box">
                  ...
                  <div class="signin">
                     <div>
                        <a href="#" @click="pushInstructor"
                           >Login bypass to make first Instructor</a
                        >
                     </div>
                     <div>
                        <a href="#" @click="pushInstructor2"
                           >Login bypass to get to students</a
                        >
                     </div>
                  </div>
               </div>
...
export default {
   ...
   methods: {
      ...
      loginInstructor() {
         ...
         axios
            .post(
               'http://localhost:80/api/v1/auth/login/instructor',
               {},
               {
                  headers: {
      ...
      loginStudent() {
         ...
         axios
            .post(
               'http://localhost:80/api/v1/auth/login/student',
               {},
               {
                  headers: {
                     Authorization: `Basic ${creds}`,
      ...
      pushInstructor() {
         ...
         localStorage.setItem(
            'auth',
            this.encodeCredentials(this.email, this.password)
         )
